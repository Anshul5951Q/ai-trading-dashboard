    ...
    <div className="flex items-center justify-center min-h-screen bg-background">
      <div className="w-full max-w-md p-8 space-y-8 bg-card rounded-xl shadow-2xl border border-border backdrop-blur-sm">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-400">Sign in to your AI Trading Portfolio Analyzer</p>
        </div>
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="text-center text-sm text-gray-400">
            Don't have an account? <Link to="/signup" className="text-primary hover:text-blue-400 font-medium ml-1">Sign up</Link>
          </div>
        </form>
      </div>
    </div>
